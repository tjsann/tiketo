...
//データを送信
const btn = document.querySelector("#PURCHASE_HISTORY_CNF")

btn.addEventListener('click', ()=>{
fetch('https://script.google.com/macros/s/AKfycbxIOTS0GCvEuhXn6DBo1KJxAVT-8oykQuVtY93n0aYhh1NhB8nA9p04F_dqgYbFmzKZ7A/exec', {
method: 'POST',
body: obj,
})
